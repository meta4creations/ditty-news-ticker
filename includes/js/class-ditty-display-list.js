...
(function($) {
	...
	Ditty_List.prototype = {
		...
		_initSlider: function() {
			...
			this.$contents.on('ditty_slider_update', { self: this }, this._triggerUpdate);
			this.$contents.on('ditty_slider_after_slide_update', { self: this }, this._triggerShowSlide);
		},
		...
		_destroySlider: function() {
			if (this.$contents.ditty_slider) {
				this.$contents.off('ditty_slider_init', { self: this }, this._triggerInit);
				this.$contents.off('ditty_slider_update', { self: this }, this._triggerUpdate);
				this.$contents.off('ditty_slider_after_slide_update', { self: this }, this._triggerShowSlide);
		...
		loadItems: function(newItems = [], swapType = 'animate') {
			...
			const { updatedItems, updatedIndexes } = dittyGetUpdatedItemData(this.settings.items, newItems);
