...
import LayoutPreviewIframe from '../common/LayoutPreviewIframe';
...
export default () => {
	...
	const [cssOverride, setCssOverride] = useState(undefined);
  ...
  const previewStyles = useMemo(() => {
    const styles = {};
    if (editorSettings.previewPadding) {
      styles.padding = editorSettings.previewPadding;
    }
    if (editorSettings.previewBg) {
      styles.background = editorSettings.previewBg;
    }
    return styles;
  }, [editorSettings.previewPadding, editorSettings.previewBg]);
	...
	return (
		<>
			...
			<div id="ditty-layout-editor" className="ditty-adminPage__app ditty">
				<div className="ditty-adminPage__app__content">
					<LayoutPreviewIframe
