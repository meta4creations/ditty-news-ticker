...
(function ($) {
  ...
  Ditty_Extension.prototype = {
    _init: function () {
      ...
      this.$elmt.on(
        "click",
        ".ditty-extension__license__submit",
        { self: this, action: "ditty_extension_license_activate" },
        this._licenseUpdate
      );
      this.$elmt.on(
        "click",
        ".ditty-extension__license__refresh",
        { self: this, action: "ditty_extension_license_refresh" },
        this._licenseUpdate
      );
      this.$elmt.on(
        "click",
        ".ditty-extension__license__deactivate",
        { self: this, action: "ditty_extension_license_deactivate" },
        this._licenseUpdate
      );
      this.$panels.on(
        "ditty_slider_before_slide_update",
        { self: this },
    ...
    _beforePanelUpdate: function (e, index, slide) {
      ...
      self.$elmt
        .find('.ditty-extension__tab[data-slide_id="' + slide.id + '"]')
        .addClass("active");
    },
    ...
    _updatePanel: function (e) {
      ...
      $form.ajaxSubmit({
        ...
        success: function (data) {
          ...
          $("#ditty-extensions").trigger("ditty_extension_panel_updated", [
            data,
            self.$elmt,
            $panel,
          ]);
    ...
    destroy: function () {
      ...
      this.$elmt.off(
        "click",
        ".ditty-extension__license__submit, .ditty-extension__license__refresh",
        { self: this, action: "ditty_extension_license_activate" },
        this._licenseUpdate
      );
      this.$elmt.off(
